...
# ==============================================================================
""" This module will marshall the contents of the service config file (service.yml)."""
import os
import sys
    ...
    def config_ingest(self):
        ...
        try:
            with open(FULL_PATH, 'r') as conf:
                ...
                self.db_addr = yaml_file['Database']['DBAddr']
                self.temp_move_path = yaml_file['Folders']['TempMoveFolder']
                self.machine_freespace_min = yaml_file['Machine']['FreeSpace']
